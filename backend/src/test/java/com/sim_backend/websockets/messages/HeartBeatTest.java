...
public class HeartBeatTest {
  ...
  public void testResponseJSON() {
    ...
    JsonElement jsonElement = heartBeat.generateMessage().get("body");
    ...
    String json = GsonUtilities.toString(heartBeat.generateMessage().get("body"));
    ...
    json = GsonUtilities.toString(heartBeat.generateMessage().get("body"));
